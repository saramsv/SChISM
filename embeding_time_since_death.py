#pythn3 embeding_time_since_death.py data/UT03-14D_01_27_14/ embeding_UT03-14D_01_27_14 names_03-14D_01_27_14
...
def extract_vector(path):
    ...
    for img in sorted(glob.glob(path + "*.JPG")):
        ...
        save_to_pickle(embedings, embeding_file)
        save_to_pickle(img_names, img_names_file)
